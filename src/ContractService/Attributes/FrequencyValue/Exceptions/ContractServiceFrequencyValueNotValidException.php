...
class ContractServiceFrequencyValueNotValidException extends ContractServiceAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'CONTRACTSERVICE_FREQUENCY_VALUE_NOT_VALID';
