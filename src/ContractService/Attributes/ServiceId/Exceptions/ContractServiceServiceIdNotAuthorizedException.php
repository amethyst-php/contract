...
class ContractServiceServiceIdNotAuthorizedException extends ContractServiceAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'CONTRACTSERVICE_SERVICE_ID_NOT_AUTHTORIZED';
