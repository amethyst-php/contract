...
abstract class ContractServiceException extends Exception implements ExceptionContract
{
    /**
     ...
     * @var string
     */
    protected $label = 'contract_service';
     ...
     * @var string
     */
    protected $code = 'CONTRACTSERVICE_ERROR';
